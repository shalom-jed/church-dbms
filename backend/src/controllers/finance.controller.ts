...
export const createIncomeRecord = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  res.status(201).json({ success: true, message: 'Income record created', data: record });
});

export const updateIncomeRecord = asyncHandler(async (req: AuthRequest, res: Response) => {
  const record = await FinanceService.updateIncomeRecord(req.params.id, req.body);
  res.json({ success: true, message: 'Income record updated', data: record });
});

export const deleteIncomeRecord = asyncHandler(async (req: AuthRequest, res: Response) => {
  const result = await FinanceService.deleteIncomeRecord(req.params.id);
...
export const createIncomeCategory = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  res.status(201).json({ success: true, message: 'Income category created', data: category });
});
...
export const createExpenseRecord = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  res.status(201).json({ success: true, message: 'Expense record created', data: record });
});

export const updateExpenseRecord = asyncHandler(async (req: AuthRequest, res: Response) => {
  const record = await FinanceService.updateExpenseRecord(req.params.id, req.body);
  res.json({ success: true, message: 'Expense record updated', data: record });
});

export const deleteExpenseRecord = asyncHandler(async (req: AuthRequest, res: Response) => {
  const result = await FinanceService.deleteExpenseRecord(req.params.id);
  res.json({ success: true, message: result.message });
});
...
export const createPledge = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  res.status(201).json({ success: true, message: 'Pledge created', data: pledge });
});
